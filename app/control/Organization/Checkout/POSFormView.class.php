...
class POSFormView extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->datagrid->addColumn( new TDataGridColumn('product_id',  'ID',  'center', '10%') );
        $this->datagrid->addColumn( new TDataGridColumn('product_description',  'Description',  'left',   '30%') );
        $this->datagrid->addColumn( new TDataGridColumn('amount',  'Amount',  'right',   '20%') );
        $this->datagrid->addColumn( new TDataGridColumn('sale_price', 'Price', 'right',   '20%') );
        $total = $this->datagrid->addColumn( new TDataGridColumn('total', 'Total', 'right',   '20%') );
