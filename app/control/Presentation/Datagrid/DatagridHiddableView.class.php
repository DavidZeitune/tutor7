 ...
 */
class DatagridHiddableView extends TPage
{
    private $datagrid;
    ...
    public function __construct()
    {
        ...
        $col_birthdate = $this->datagrid->addColumn( new TDataGridColumn('birthdate', 'Birthdate', 'left') );
        $col_phone     = $this->datagrid->addColumn( new TDataGridColumn('phone',     'Phone',     'left') );
        $col_email     = $this->datagrid->addColumn( new TDataGridColumn('email',     'Email',     'left') );
        $col_city      = $this->datagrid->addColumn( new TDataGridColumn('city',      'City',      'left') );
        $col_state     = $this->datagrid->addColumn( new TDataGridColumn('state',     'State',     'left') );
        $col_country   = $this->datagrid->addColumn( new TDataGridColumn('country',   'Country',   'left') );
