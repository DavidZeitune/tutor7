...
class TemplateViewAdvancedView extends TPage
{
    ...
    public function onAction1()
    {
        ...
        $form->addAction('Show', new TAction(array($this, 'onForm1')), 'far:check-circle');
    ...
    public function onAction2()
    {
        ...
        $datagrid->addColumn( new TDataGridColumn('code',  'Code',  'center', '10%') );
        $datagrid->addColumn( new TDataGridColumn('name',  'Name',  'left',   '70%') );
